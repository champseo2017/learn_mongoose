...
อัพเดต Document 
เมื่อต้องการอัพเดตข้อมูลรายการเดียว เราจะใช้เมธอด updateOne() แต่ถ้าต้องการอัพเดตข้อมูลหลายๆ รายการพร้อมกันก็จะใช้ updatemany() เมธอดทั้งสองจะมีพารามิเตอร์อยู่สองตัวดังนี้

- พารามิเตอร์แรก คือ ออบเจ็กต์คิวรี ที่ใช้เลือก Document ที่ต้องการอัพเดต
- พารามิเตอร์ที่สอง คือ คำสั่งสำหรับอัพเดตฐานข้อมูล โดยใช้ MongoDb
Update Operator เช่น $set, $min, $max 

$currentDate กำหนดวันเวลาปัจจุบันไปยังฟิลด์
$inc เพิ่มค่าให้กับฟิลด์ ด้วยค่าที่กำหนด
$min อัพเดตเป็นค่าใหม่ หากค่าใหม่น้อยกว่าค่าเดิมที่อยู่ในฟิลด์
$max อัพเดตเป็นค่าใหม่ เมื่อค่าใหม่มากกว่าค่าเดิมที่อยู่ในฟิลด์
$mul คูณค่าให้กับฟิลด์ ด้วยค่าที่กำหนด
$rename เปลียนชื่อฟิลด์
$set กำหนดค่าให้กับฟิลด์ต่างๆ ที่อยู่ใน Document
$setOnInsert กำหนดค่าให้กับฟิลด์ หากเป็นการแทรกข้อมูลใหม่ไปยังฐานข้อมูล
$unset ลบฟิลด์ที่กำหนดออกจาก Document
